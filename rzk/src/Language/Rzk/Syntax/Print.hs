...
instance Print (Language.Rzk.Syntax.Abs.Term' a) where
  prt i = \case
    ...
    Language.Rzk.Syntax.Abs.ShapeType _ pattern_ term1 term2 -> prPrec i 7 (concatD [doc (showString "shape"), doc (showString "("), prt 0 pattern_, doc (showString ":"), prt 0 term1, doc (showString "|"), prt 0 term2, doc (showString ")")])
    Language.Rzk.Syntax.Abs.ShapeTypeModal _ pattern_ modalcolon term1 term2 -> prPrec i 7 (concatD [doc (showString "shape"), doc (showString "("), prt 0 pattern_, prt 0 modalcolon, prt 0 term1, doc (showString "|"), prt 0 term2, doc (showString ")")])
    Language.Rzk.Syntax.Abs.ShapeIntro _ term -> prPrec i 6 (concatD [doc (showString "form"), prt 7 term])
    Language.Rzk.Syntax.Abs.ShapeElim _ term -> prPrec i 6 (concatD [doc (showString "unform"), prt 7 term])
    Language.Rzk.Syntax.Abs.LetMod _ modality bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetModExt _ modality bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), doc (showString "mod"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetModComp _ modality1 modality2 bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality1, doc (showString "mod"), prt 0 modality2, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetModInto _ modality bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
    Language.Rzk.Syntax.Abs.LetModExtInto _ modality bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), doc (showString "mod"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
    Language.Rzk.Syntax.Abs.LetModCompInto _ modality1 modality2 bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality1, doc (showString "mod"), prt 0 modality2, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
