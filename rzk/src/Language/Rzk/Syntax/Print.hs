...
instance Print (Language.Rzk.Syntax.Abs.Term' a) where
  prt i = \case
    Language.Rzk.Syntax.Abs.Universe _ -> prPrec i 8 (concatD [doc (showString "U")])
    Language.Rzk.Syntax.Abs.UniverseCube _ -> prPrec i 8 (concatD [doc (showString "CUBE")])
    Language.Rzk.Syntax.Abs.UniverseTope _ -> prPrec i 8 (concatD [doc (showString "TOPE")])
    Language.Rzk.Syntax.Abs.CubeUnit _ -> prPrec i 8 (concatD [doc (showString "1")])
    Language.Rzk.Syntax.Abs.CubeUnitStar _ -> prPrec i 8 (concatD [doc (showString "*\8321")])
    Language.Rzk.Syntax.Abs.Cube2 _ -> prPrec i 8 (concatD [doc (showString "2")])
    Language.Rzk.Syntax.Abs.Cube2_0 _ -> prPrec i 8 (concatD [doc (showString "0\8322")])
    Language.Rzk.Syntax.Abs.Cube2_1 _ -> prPrec i 8 (concatD [doc (showString "1\8322")])
    Language.Rzk.Syntax.Abs.CubeI _ -> prPrec i 8 (concatD [doc (showString "\120128")])
    Language.Rzk.Syntax.Abs.CubeI_0 _ -> prPrec i 8 (concatD [doc (showString "0\7522")])
    Language.Rzk.Syntax.Abs.CubeI_1 _ -> prPrec i 8 (concatD [doc (showString "1\7522")])
    ...
    Language.Rzk.Syntax.Abs.TopeTop _ -> prPrec i 8 (concatD [doc (showString "\8868")])
    Language.Rzk.Syntax.Abs.TopeBottom _ -> prPrec i 8 (concatD [doc (showString "\8869")])
    ...
    Language.Rzk.Syntax.Abs.RecBottom _ -> prPrec i 8 (concatD [doc (showString "recBOT")])
    Language.Rzk.Syntax.Abs.RecOr _ restrictions -> prPrec i 8 (concatD [doc (showString "recOR"), doc (showString "("), prt 0 restrictions, doc (showString ")")])
    ...
    Language.Rzk.Syntax.Abs.TypeUnit _ -> prPrec i 8 (concatD [doc (showString "Unit")])
    ...
    Language.Rzk.Syntax.Abs.Pair _ term1 term2 -> prPrec i 8 (concatD [doc (showString "("), prt 0 term1, doc (showString ","), prt 0 term2, doc (showString ")")])
    Language.Rzk.Syntax.Abs.Tuple _ term1 term2 terms -> prPrec i 8 (concatD [doc (showString "("), prt 0 term1, doc (showString ","), prt 0 term2, doc (showString ","), prt 0 terms, doc (showString ")")])
    ...
    Language.Rzk.Syntax.Abs.LetModBind _ modality bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetMod _ modality bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), doc (showString "mod"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetModFramed _ modality1 modality2 bind term1 term2 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality1, doc (showString "mod"), prt 0 modality2, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "in"), prt 0 term2])
    Language.Rzk.Syntax.Abs.LetModBindInto _ modality bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
    Language.Rzk.Syntax.Abs.LetModInto _ modality bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), doc (showString "mod"), prt 0 modality, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
    Language.Rzk.Syntax.Abs.LetModFramedInto _ modality1 modality2 bind term1 term2 term3 -> prPrec i 1 (concatD [doc (showString "let"), prt 0 modality1, doc (showString "mod"), prt 0 modality2, prt 0 bind, doc (showString ":="), prt 0 term1, doc (showString "into"), prt 0 term2, doc (showString "in"), prt 0 term3])
    ...
    Language.Rzk.Syntax.Abs.Unit _ -> prPrec i 8 (concatD [doc (showString "unit")])
    Language.Rzk.Syntax.Abs.Refl _ -> prPrec i 8 (concatD [doc (showString "refl")])
    Language.Rzk.Syntax.Abs.ReflTerm _ term -> prPrec i 8 (concatD [doc (showString "refl_{"), prt 0 term, doc (showString "}")])
    Language.Rzk.Syntax.Abs.ReflTermType _ term1 term2 -> prPrec i 8 (concatD [doc (showString "refl_{"), prt 0 term1, doc (showString ":"), prt 0 term2, doc (showString "}")])
    Language.Rzk.Syntax.Abs.IdJ _ term1 term2 term3 term4 term5 term6 -> prPrec i 8 (concatD [doc (showString "idJ"), doc (showString "("), prt 0 term1, doc (showString ","), prt 0 term2, doc (showString ","), prt 0 term3, doc (showString ","), prt 0 term4, doc (showString ","), prt 0 term5, doc (showString ","), prt 0 term6, doc (showString ")")])
    Language.Rzk.Syntax.Abs.Match _ term matchbranchs -> prPrec i 7 (concatD [doc (showString "match"), prt 8 term, doc (showString "("), prt 0 matchbranchs, doc (showString ")")])
    Language.Rzk.Syntax.Abs.MatchInto _ term1 term2 matchbranchs -> prPrec i 7 (concatD [doc (showString "match"), prt 8 term1, doc (showString "into"), prt 8 term2, doc (showString "("), prt 0 matchbranchs, doc (showString ")")])
    Language.Rzk.Syntax.Abs.MatchModal _ modality term matchbranchs -> prPrec i 7 (concatD [doc (showString "match"), prt 0 modality, prt 8 term, doc (showString "("), prt 0 matchbranchs, doc (showString ")")])
    Language.Rzk.Syntax.Abs.MatchModalInto _ modality term1 term2 matchbranchs -> prPrec i 7 (concatD [doc (showString "match"), prt 0 modality, prt 8 term1, doc (showString "into"), prt 8 term2, doc (showString "("), prt 0 matchbranchs, doc (showString ")")])
    Language.Rzk.Syntax.Abs.Hole _ holeident -> prPrec i 8 (concatD [prt 0 holeident])
    Language.Rzk.Syntax.Abs.Var _ varident -> prPrec i 8 (concatD [prt 0 varident])
    Language.Rzk.Syntax.Abs.TypeAsc _ term1 term2 -> prPrec i 0 (concatD [prt 2 term1, doc (showString "as"), prt 1 term2])
    Language.Rzk.Syntax.Abs.ASCII_CubeUnitStar _ -> prPrec i 8 (concatD [doc (showString "*_1")])
    Language.Rzk.Syntax.Abs.ASCII_Cube2_0 _ -> prPrec i 8 (concatD [doc (showString "0_2")])
    Language.Rzk.Syntax.Abs.ASCII_Cube2_1 _ -> prPrec i 8 (concatD [doc (showString "1_2")])
    Language.Rzk.Syntax.Abs.ASCII_CubeI _ -> prPrec i 8 (concatD [doc (showString "II")])
    Language.Rzk.Syntax.Abs.ASCII_CubeI_0 _ -> prPrec i 8 (concatD [doc (showString "0_I")])
    Language.Rzk.Syntax.Abs.ASCII_CubeI_1 _ -> prPrec i 8 (concatD [doc (showString "1_I")])
    Language.Rzk.Syntax.Abs.ASCII_TopeTop _ -> prPrec i 8 (concatD [doc (showString "TOP")])
    Language.Rzk.Syntax.Abs.ASCII_TopeBottom _ -> prPrec i 8 (concatD [doc (showString "BOT")])
