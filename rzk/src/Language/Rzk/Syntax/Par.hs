...
happyReduction_44 (happy_x_4 `HappyStk`
	...
	case happyOut56 happy_x_4 of { (HappyWrap56 happy_var_4) -> 
	happyIn38
		 ((uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1), Language.Rzk.Syntax.Abs.CommandDefineAssume (uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1)) (snd happy_var_2) (snd happy_var_4))
	) `HappyStk` happyRest}}}
...
happyReduction_45 (happy_x_4 `HappyStk`
	...
	case happyOut56 happy_x_4 of { (HappyWrap56 happy_var_4) -> 
	happyIn38
		 ((uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1), Language.Rzk.Syntax.Abs.commandDefineVariable (uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1)) (snd happy_var_2) (snd happy_var_4))
	) `HappyStk` happyRest}}}
...
happyReduction_46 (happy_x_4 `HappyStk`
	...
	case happyOut56 happy_x_4 of { (HappyWrap56 happy_var_4) -> 
	happyIn38
		 ((uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1), Language.Rzk.Syntax.Abs.commandDefineVariables (uncurry Language.Rzk.Syntax.Abs.BNFC'Position (tokenLineCol happy_var_1)) (snd happy_var_2) (snd happy_var_4))
	) `HappyStk` happyRest}}}
...
happyReduce_53 = happyReduce 8# 9# happyReduction_53
...
happyReduce_54 = happyReduce 7# 9# happyReduction_54
...
happyReduce_68 = happyReduce 7# 15# happyReduction_68
...
happyReduce_76 = happyReduce 9# 17# happyReduction_76
...
happyReduce_94 = happyReduce 10# 20# happyReduction_94
happyReduction_94 (happy_x_10 `HappyStk`
	happy_x_9 `HappyStk`
	happy_x_8 `HappyStk`
	happy_x_7 `HappyStk`
	happy_x_6 `HappyStk`
...
happyReduce_102 = happyReduce 14# 20# happyReduction_102
happyReduction_102 (happy_x_14 `HappyStk`
	happy_x_13 `HappyStk`
	happy_x_12 `HappyStk`
	happy_x_11 `HappyStk`
	happy_x_10 `HappyStk`
...
happyReduce_127 = happyReduce 8# 25# happyReduction_127
...
happyReduce_128 = happyReduce 5# 25# happyReduction_128
...
happyReduce_134 = happyReduce 4# 25# happyReduction_134
...
happyReduce_135 = happyReduce 8# 25# happyReduction_135
...
happyReduce_136 = happyReduce 4# 26# happyReduction_136
...
happyReduce_141 = happySpecReduce_2  26# happyReduction_141
...
happyNewToken action sts stk (tk:tks) =
	...
	PT _ (TL _) -> cont 81#;
	PT _ (T_VarIdentToken _) -> cont 82#;
	PT _ (T_HoleIdentToken _) -> cont 83#;
	_ -> happyError' ((tk:tks), [])
	}
