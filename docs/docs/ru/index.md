...
[Попробовать Rzk в онлайн-песочнице](https://rzk-lang.github.io/rzk/playground/){ .md-button }
...
Для небольших формализаций, умещающихся в один файл, можно также воспользоваться [онлайн-песочницей Rzk](https://rzk-lang.github.io/rzk/playground/).
